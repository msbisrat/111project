...
# ── Page title ────────────────────────────────────────────────────────────────
st.title("Personalized Heart Disease Risk Predictor")
...
with tab_clinical:
    ...
    with st.expander("Symptoms (optional)", expanded=False):
...
with tab_lifestyle:
    ...
    st.caption("Based on CDC BRFSS: these personalize your risk score.")
